            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        ?></h6>
                        <span>Admin Hello</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    <a href="index.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                  
                    <!-- rename Element with Categories -->
                    ...
                    <!-- copy above Category Component and paste below and rename with Products -->
                    <div class="nav-item dropdown">
                    ...
                    <a href="invoices.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Invoices</a>
