...
if(isset($_POST['addToCart'])){
	if(isset($_SESSION['finalCart'])){
			...
			if(in_array($_POST['productId'],$productIdsArray)){

				echo "<script>alert('product is already added to the cart');</script>";
			}
			else{
			$count = count($_SESSION['finalCart']);
			$_SESSION['finalCart'][$count] = array("p_id"=>$_POST['productId'],"p_name"=>$_POST['productName'],"p_price"=>$_POST['productPrice'],"p_image"=>$_POST['productImage'],"p_qty"=>$_POST['num-product']);
			echo "<script>alert('cart added successfully')</script>";
		}
	}
	else{
		$_SESSION['finalCart'][0] = array("p_id"=>$_POST['productId'],"p_name"=>$_POST['productName'],"p_price"=>$_POST['productPrice'],"p_image"=>$_POST['productImage'],"p_qty"=>$_POST['num-product']);
		echo "<script>alert('cart added successfully')</script>";
	}
}
// remove Work
